...
public interface HCNetSDKByJNA extends Library {
	...
	public static final int	ANHUI_PROVINCE  = 0;   //安徽
	public static final int AOMEN_PROVINCE = 1; //澳门
	public static final int BEIJING_PROVINCE= 2;  //北京
	public static final int CHONGQING_PROVINCE = 3; //重庆
	public static final int FUJIAN_PROVINCE = 4;     //福建
	public static final int GANSU_PROVINCE  = 5;    //甘肃
	public static final int GUANGDONG_PROVINCE= 6;    //广东
	public static final int GUANGXI_PROVINCE  = 7;    //广西
	public static final int GUIZHOU_PROVINCE  = 8;    //贵州
	public static final int HAINAN_PROVINCE   = 9;    //海南
	public static final int HEBEI_PROVINCE    = 10;   //河北
	public static final int HENAN_PROVINCE    = 11;   //河南
	public static final int HEILONGJIANG_PROVINCE = 12;   //黑龙江
	public static final int HUBEI_PROVINCE    = 13;   //湖北
	public static final int HUNAN_PROVINCE    = 14;   //湖南
	public static final int JILIN_PROVINCE    = 15;   //吉林
	public static final int JIANGSU_PROVINCE  = 16;   //江苏
	public static final int JIANGXI_PROVINCE  = 17;   //江西
	public static final int LIAONING_PROVINCE = 18;   //辽宁
	public static final int NEIMENGGU_PROVINCE= 19;   //内蒙古
	public static final int NINGXIA_PROVINCE  = 20;   //宁夏
	public static final int QINGHAI_PROVINCE  = 21;   //青海
	public static final int SHANDONG_PROVINCE = 22;   //山东
	public static final int SHANXI_JIN_PROVINCE = 23;   //山西
	public static final int SHANXI_SHAN_PROVINCE = 24;   //陕西
	public static final int SHANGHAI_PROVINCE = 25;   //上海
	public static final int SICHUAN_PROVINCE  = 26;   //四川
	public static final int TAIWAN_PROVINCE   = 27;   //台湾
	public static final int TIANJIN_PROVINCE  = 28;   //天津
	public static final int XIZANG_PROVINCE   = 29;   //西藏
	public static final int XIANGGANG_PROVINCE= 30;   //香港
	public static final int XINJIANG_PROVINCE = 31;   //新疆
	public static final int YUNNAN_PROVINCE   = 32;   //云南
	public static final int ZHEJIANG_PROVINCE = 33;    //浙江
	public static final int ALL_UNKNOW  = 0xfe;//未知
	...
	public static class NET_VCA_HUMAN_FEATURE extends Structure
	{
		...
		protected List<String> getFieldOrder() {
			// TODO Auto-generated method stub
			return Arrays.asList("byAgeGroup", "bySex", "byEyeGlass", "byRes");
		}
	}
	...
	public static class NET_VCA_FACESNAP_RESULT extends Structure
	{
	    ...
	    public ByteByReference pBuffer1;  //人脸子图的图片数据
	    public ByteByReference pBuffer2;  //背景图的图片数据（保留，通过查找背景图接口可以获取背景图）
	    ...
	    protected List<String> getFieldOrder() {
			// TODO Auto-generated method stub
			return Arrays.asList("dwSize", "dwRelativeTime", "dwAbsTime", "dwFacePicID",
					"dwFaceScore", "struTargetInfo", "struRect", "struDevInfo",
					"dwFacePicLen", "dwBackgroundPicLen", "bySmart", "byAlarmEndMark",
					"byRepeatTimes", "byRes", "struFeature", "fStayDuration",
					"sStorageIP", "wStoragePort", "wDevInfoIvmsChannelEx", "byRes1",
					"pBuffer1", "pBuffer2"
					);
		}
	}
	...
	{ 
	    ...
	    public short  dwCode; //国家标准的省份、城市、县级代码，当这个字段不为0的时候，使用这个值，新设备上传这个值表示籍贯参数，老设备这个值为0
	...
	public static class NET_VCA_HUMAN_ATTRIBUTE extends Structure
	{
	    ...
	    public byte      []byBirthDate = new byte[MAX_HUMAN_BIRTHDATE_LEN/*10*/]; //出生年月，如：201106
	    public byte      []byName = new byte[NAME_LEN/*32*/]; //姓名
	    public NET_DVR_AREAINFOCFG struNativePlace = new NET_DVR_AREAINFOCFG(); //籍贯参数
	    public byte    []byCertificateNumber= new byte[NAME_LEN/*32*/];  //证件号
	    public int   dwPersonInfoExtendLen;// 人员标签信息扩展长度
	    public ByteByReference pPersonInfoExtend;  //人员标签信息扩展信息
	//（人员标签信息扩展信息格式参考：人脸比对此接口对应《人脸对比相关功能_ISAPI概要设计说明书》文档中URL：/ISAPI/System/Video/inputs/channels/<ID>/faceContrast/personInfoExtend  PersonInfoExtendList XML格式解析
	    public byte    [] byRes2 = new byte[12];  //保留字节
	    
	    protected List<String> getFieldOrder() {
			// TODO Auto-generated method stub
			return Arrays.asList("bySex", "byCertificateType", "byBirthDate", "byName","struNativePlace",
					"byCertificateNumber", "dwPersonInfoExtendLen", "pPersonInfoExtend", "byRes2");
		}
	}
	...
	public static class NET_VCA_BLACKLIST_INFO extends Structure
	{
	    ...
	    protected List<String> getFieldOrder() {
			// TODO Auto-generated method stub
			return Arrays.asList("dwSize", "dwRegisterID", "dwGroupNo", "byType","byLevel",
					"byRes1", "struAttribute", "byRemark", "byRes2");
		}
	}
	...
	public static class NET_VCA_BLACKLIST_INFO_ALARM extends Structure
	{
	    ...
	    public ByteByReference pBuffer1;  //黑名单人脸子图的图片数据
	    
	    protected List<String> getFieldOrder() {
			// TODO Auto-generated method stub
			return Arrays.asList("struBlackListInfo", "dwBlackListPicLen", "byRes", "pBuffer1");
		}
	}
	...
	//抓拍图片人脸年龄的使用方式，如byAge为15,byAgeDeviation为1,表示，实际人脸图片年龄的为14-16之间
	    ...
	    public ByteByReference pUIDBuffer;  //标识指针
	    public byte     []byRes = new byte[4];              // 保留字节
	    public ByteByReference pBuffer1;  //抓拍人脸子图的图片数据
	    
	    protected List<String> getFieldOrder() {
			// TODO Auto-generated method stub
			return Arrays.asList("dwRelativeTime", "dwAbsTime", "dwSnapFacePicID", "dwSnapFacePicLen","struDevInfo",
					"byFaceScore", "bySex", "byGlasses", "byAge",
					"byAgeDeviation", "byRes1", "dwUIDLen", "pUIDBuffer","byRes", "pBuffer1");
		}
	}
	...
	public static class NET_VCA_FACESNAP_MATCH_ALARM extends Structure
	{
	    ...
	    public ByteByReference pSnapPicBuffer;//设备识别抓拍图片指针
	    public NET_VCA_RECT  struRegion = new NET_VCA_RECT();//目标边界框，设备识别抓拍图片中，人脸子图坐标
	    public int  dwModelDataLen;//建模数据长度
	    public ByteByReference pModelDataBuffer;// 建模数据指针
	    public byte     []byRes2 = new byte[8];// 保留字节
	    ...
	    protected List<String> getFieldOrder() {
			// TODO Auto-generated method stub
			return Arrays.asList("dwSize", "fSimilarity", "struSnapInfo", "struBlackListInfo","sStorageIP",
					"wStoragePort", "byMatchPicNum", "byRes", "dwSnapPicLen",
					"pSnapPicBuffer", "struRegion", "dwModelDataLen", "pModelDataBuffer","byRes2");
		}
	}
