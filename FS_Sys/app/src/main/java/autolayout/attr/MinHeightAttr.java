 ...
 */
public class MinHeightAttr extends autolayout.attr.AutoAttr
{
    ...
    {
        return autolayout.attr.Attrs.MIN_HEIGHT;
    }
    ...
    public static MinHeightAttr generate(int val, int baseFlag)
    {
        ...
        switch (baseFlag)
        {
            case autolayout.attr.AutoAttr.BASE_WIDTH:
                attr = new MinHeightAttr(val, autolayout.attr.Attrs.MIN_HEIGHT, 0);
                break;
            case autolayout.attr.AutoAttr.BASE_HEIGHT:
                attr = new MinHeightAttr(val, 0, autolayout.attr.Attrs.MIN_HEIGHT);
                break;
