 ...
 */
public class WidthAttr extends autolayout.attr.AutoAttr
{
    ...
    {
        return autolayout.attr.Attrs.WIDTH;
    }
    ...
    public static WidthAttr generate(int val, int baseFlag)
    {
        ...
        switch (baseFlag)
        {
            case autolayout.attr.AutoAttr.BASE_WIDTH:
                widthAttr = new WidthAttr(val, autolayout.attr.Attrs.WIDTH, 0);
                break;
            case autolayout.attr.AutoAttr.BASE_HEIGHT:
                widthAttr = new WidthAttr(val, 0, autolayout.attr.Attrs.WIDTH);
                break;
