 ...
 */
public class MarginBottomAttr extends autolayout.attr.AutoAttr
{
    ...
    {
        return autolayout.attr.Attrs.MARGIN_BOTTOM;
    }
    ...
    public static MarginBottomAttr generate(int val, int baseFlag)
    {
        ...
        switch (baseFlag)
        {
            case autolayout.attr.AutoAttr.BASE_WIDTH:
                attr = new MarginBottomAttr(val, autolayout.attr.Attrs.MARGIN_BOTTOM, 0);
                break;
            case autolayout.attr.AutoAttr.BASE_HEIGHT:
                attr = new MarginBottomAttr(val, 0, autolayout.attr.Attrs.MARGIN_BOTTOM);
                break;
