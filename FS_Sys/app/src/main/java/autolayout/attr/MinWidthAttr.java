 ...
 */
public class MinWidthAttr extends autolayout.attr.AutoAttr
{
    ...
    {
        return autolayout.attr.Attrs.MIN_WIDTH;
    }
    ...
    public static MinWidthAttr generate(int val, int baseFlag)
    {
        ...
        switch (baseFlag)
        {
            case autolayout.attr.AutoAttr.BASE_WIDTH:
                attr = new MinWidthAttr(val, autolayout.attr.Attrs.MIN_WIDTH, 0);
                break;
            case autolayout.attr.AutoAttr.BASE_HEIGHT:
                attr = new MinWidthAttr(val, 0, autolayout.attr.Attrs.MIN_WIDTH);
                break;
