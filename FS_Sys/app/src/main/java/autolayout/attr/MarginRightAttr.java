 ...
 */
public class MarginRightAttr extends autolayout.attr.AutoAttr
{
    ...
    {
        return autolayout.attr.Attrs.MARGIN_RIGHT;
    }
    ...
    public static MarginRightAttr generate(int val, int baseFlag)
    {
        ...
        switch (baseFlag)
        {
            case autolayout.attr.AutoAttr.BASE_WIDTH:
                attr = new MarginRightAttr(val, autolayout.attr.Attrs.MARGIN_RIGHT, 0);
                break;
            case autolayout.attr.AutoAttr.BASE_HEIGHT:
                attr = new MarginRightAttr(val, 0, autolayout.attr.Attrs.MARGIN_RIGHT);
                break;
