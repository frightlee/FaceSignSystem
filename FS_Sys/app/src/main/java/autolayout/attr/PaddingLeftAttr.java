 ...
 */
public class PaddingLeftAttr extends autolayout.attr.AutoAttr
{
    ...
    {
        return autolayout.attr.Attrs.PADDING_LEFT;
    }
    ...
    public static PaddingLeftAttr generate(int val, int baseFlag)
    {
        ...
        switch (baseFlag)
        {
            case autolayout.attr.AutoAttr.BASE_WIDTH:
                attr = new PaddingLeftAttr(val, autolayout.attr.Attrs.PADDING_LEFT, 0);
                break;
            case autolayout.attr.AutoAttr.BASE_HEIGHT:
                attr = new PaddingLeftAttr(val, 0, autolayout.attr.Attrs.PADDING_LEFT);
                break;
